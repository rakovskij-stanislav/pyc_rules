rule python_bytecode_version__1_5 {
    meta:
        ...
        license = "MIT"
        date = "2026-01-18" // latest ruleset update
    condition:
...
rule python_bytecode_version__3_15a1 {
    ...
    condition:
        ...
        uint32be(0) == 0x470e0d0a
}

rule python_bytecode_version__3_15a2 {
    meta:
        reference = "https://github.com/rakovskij-stanislav/pyc_rules"
        description = "Python bytecode from version 3.15a2"
        author = "Rakovsky Stanislav @ https://t.me/disasm_me_ch"
        license = "MIT"
        date = "2026-01-18" // latest ruleset update
    condition:
