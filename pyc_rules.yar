rule python_bytecode_version__1_5 {
    meta:
        ...
        license = "MIT"
        date = "2026-08-16" // latest ruleset update
    condition:
...
rule python_bytecode_version__3_14b3 {
    meta:
        reference = "https://github.com/rakovskij-stanislav/pyc_rules"
        description = "Python bytecode from version 3.14b3"
        author = "Rakovsky Stanislav @ https://t.me/disasm_me_ch"
        license = "MIT"
        date = "2026-08-16" // latest ruleset update
    condition:
        uint32be(0) == 0x290e0d0a
}

rule python_bytecode_version__3_14rc2 {
    meta:
        reference = "https://github.com/rakovskij-stanislav/pyc_rules"
        description = "Python bytecode from version 3.14rc2"
        author = "Rakovsky Stanislav @ https://t.me/disasm_me_ch"
        license = "MIT"
        date = "2026-08-16" // latest ruleset update
    condition:
        uint32be(0) == 0x2a0e0d0a
}

rule python_bytecode_version__3_14rc3 {
    meta:
        reference = "https://github.com/rakovskij-stanislav/pyc_rules"
        description = "Python bytecode from version 3.14rc3"
        author = "Rakovsky Stanislav @ https://t.me/disasm_me_ch"
        license = "MIT"
        date = "2026-08-16" // latest ruleset update
    condition:
        uint32be(0) == 0x2b0e0d0a
}
...
rule python_bytecode_version__3_15a1 {
    ...
    condition:
        ...
        uint32be(0) == 0x450e0d0a or 
        uint32be(0) == 0x460e0d0a or 
        uint32be(0) == 0x470e0d0a or 
        uint32be(0) == 0x480e0d0a
}

rule python_bytecode_version__3_15a4 {
    meta:
        reference = "https://github.com/rakovskij-stanislav/pyc_rules"
        description = "Python bytecode from version 3.15a4"
        author = "Rakovsky Stanislav @ https://t.me/disasm_me_ch"
        license = "MIT"
        date = "2026-08-16" // latest ruleset update
    condition:
        uint32be(0) == 0x490e0d0a or 
        uint32be(0) == 0x4a0e0d0a or 
        uint32be(0) == 0x4b0e0d0a or 
        uint32be(0) == 0x4c0e0d0a or 
        uint32be(0) == 0x4d0e0d0a
}

rule python_bytecode_version__3_15a8 {
    meta:
        reference = "https://github.com/rakovskij-stanislav/pyc_rules"
        description = "Python bytecode from version 3.15a8"
        author = "Rakovsky Stanislav @ https://t.me/disasm_me_ch"
        license = "MIT"
        date = "2026-08-16" // latest ruleset update
    condition:
        uint32be(0) == 0x4e0e0d0a or 
        uint32be(0) == 0x4f0e0d0a or 
        uint32be(0) == 0x500e0d0a or 
        uint32be(0) == 0x510e0d0a
}

rule python_bytecode_version__3_15b1 {
    meta:
        reference = "https://github.com/rakovskij-stanislav/pyc_rules"
        description = "Python bytecode from version 3.15b1"
        author = "Rakovsky Stanislav @ https://t.me/disasm_me_ch"
        license = "MIT"
        date = "2026-08-16" // latest ruleset update
    condition:
        uint32be(0) == 0x520e0d0a
}

rule python_bytecode_version__3_16a0 {
    meta:
        reference = "https://github.com/rakovskij-stanislav/pyc_rules"
        description = "Python bytecode from version 3.16a0"
        author = "Rakovsky Stanislav @ https://t.me/disasm_me_ch"
        license = "MIT"
        date = "2026-08-16" // latest ruleset update
    condition:
        uint32be(0) == 0x740e0d0a or 
        uint32be(0) == 0x750e0d0a
}

rule python_bytecode_version__3_16a1 {
    meta:
        reference = "https://github.com/rakovskij-stanislav/pyc_rules"
        description = "Python bytecode from version 3.16a1"
        author = "Rakovsky Stanislav @ https://t.me/disasm_me_ch"
        license = "MIT"
        date = "2026-08-16" // latest ruleset update
    condition:
        uint32be(0) == 0x760e0d0a or 
        uint32be(0) == 0x770e0d0a or 
        uint32be(0) == 0x780e0d0a or 
        uint32be(0) == 0x790e0d0a
}
